/// <amd-dependency path="/lib/require.d.ts" />
/// <amd-dependency path="/lib/jquery.d.ts" />
/// <amd-dependency path="/lib/knockout.d.ts" />
...
var NewViewModel = (function () {
    function NewViewModel() {
        ...
        this.OnGetInfo = function () {
            ...
            var send = JSON.stringify(info);
            document.location.hash = "mailto:windowsyuli@dbis.nankai.edu.cn;?subject=Feedback&body=" + send;
        };
